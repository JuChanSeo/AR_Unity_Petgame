...
public class random_play : MonoBehaviour
{
    ...
    {
        time_remain_text.enabled = true;
    }

    void Start()
    {
        time_remain_text.enabled = false;
    ...
    public void when_game_start_flag_is_true()
    {
        ...
        if (contents1_script.c1_flag == true || contents2_script.c2_flag == true ||
            contents3_script.c3_flag == true || contents4_script.c4_flag == true)
        {
